...
const routes = [
  { from: "Agra", to: "Delhi", km: "230 km", time: "4 hrs" },
  { from: "Agra", to: "Jaipur", km: "240 km", time: "4.5 hrs" },
  { from: "Agra", to: "Mathura", km: "55 km", time: "1.5 hrs" },
  { from: "Agra", to: "Vrindavan", km: "70 km", time: "2 hrs" },
  { from: "Agra", to: "Noida", km: "200 km", time: "3.5 hrs" },
  { from: "Agra", to: "Gurgaon", km: "220 km", time: "4 hrs" },
  { from: "Agra", to: "Lucknow", km: "335 km", time: "6 hrs" },
  { from: "Agra", to: "Ayodhya", km: "475 km", time: "8 hrs" },
];
          ...
          <div className="max-w-3xl">
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              <a href="tel:+919999999999"
                ...
                <Phone className="h-5 w-5" /> Call Now: +91 99999 99999
              </a>
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-6 lg:grid-cols-2">
          <div>
            ...
            <div className="mt-8 space-y-4 text-foreground">
              <a href="tel:+919999999999" className="flex items-center gap-3"><Phone className="h-5 w-5 text-primary" /> +91 99999 99999</a>
              <a href="https://wa.me/919999999999" className="flex items-center gap-3"><MessageCircle className="h-5 w-5 text-primary" /> WhatsApp: +91 99999 99999</a>
