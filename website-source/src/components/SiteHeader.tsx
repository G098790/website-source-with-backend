      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6">
        <Link to="/" className="flex items-center gap-3">
          ...
          <div className="leading-tight">
            <div className="font-display text-lg font-bold text-primary">Mansi Tour & Travels</div>
            <div className="text-[11px] tracking-[0.2em] text-muted-foreground uppercase">Yatra • Aastha • Aaram</div>
          </div>
        </Link>

        <nav className="hidden items-center gap-8 md:flex">
          <Link to="/" className="text-sm font-medium text-foreground hover:text-primary [&.active]:text-primary">Home</Link>
          <Link to="/services" className="text-sm font-medium text-foreground hover:text-primary [&.active]:text-primary">Services & Tours</Link>
          <a href="/#routes" className="text-sm font-medium text-foreground hover:text-primary">Routes</a>
